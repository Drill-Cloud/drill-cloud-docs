...
- [Наблюдаемость](observability/index.md) — Grafana, бизнес-дашборды, инфраструктура и расследование инцидентов.
- [Автотестирование](testing/index.md) — ручной запуск, профили, окружения и анализ результатов.
...
Grafana отвечает на вопрос «что происходит с работающей системой сейчас и где искать причину отклонения». GitHub Actions и ReportPortal отвечают на вопрос «проходит ли воспроизводимый пользовательский сценарий и на каком шаге он сломался». При проверке релиза и расследовании инцидентов эти инструменты используются вместе.
